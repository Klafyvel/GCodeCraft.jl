...
# Source repository: https://github.com/MarlinFirmware/MarlinDocumentation.git
# Generated from commit: 36dcf30341bacc33544a4792e10502901a771d44
...
CODES = [
    ...
    (
        codetype = "M",
        identifier = (210, 0, nothing),
        funname = "M210",
        doc = "    M210(;params...)\nSet homing feedrate for one or more axes\n\n*Note:* This documentation has been automatically generated from [Marlin's G-Code documentation](https://marlinfw.org/docs/gcode/M210.html).\n\n\n# Marlin parameters\nNote: these are Marlin's G-Code parameters. GCodeCraft.jl does not inforce them.\n* X [Optional]: X homing feedrate\n* Y [Optional]: Y homing feedrate\n* Z [Optional]: Z homing feedrate\n* A [Optional]: A homing feedrate\n* B [Optional]: B homing feedrate\n* C [Optional]: C homing feedrate\n* U [Optional]: U homing feedrate\n* V [Optional]: V homing feedrate\n* W [Optional]: W homing feedrate\n\n\n# Description\n\nSet the [`G28`](/docs/gcode/G028.html) homing feedrate for one or more axes.\n\n\nSee also [`G28`](@ref).",
    ),
    (
        codetype = "M",
    ...
    (
        codetype = "M",
        identifier = (550, 0, nothing),
        funname = "M550",
        doc = "    M550(;params...)\nSet / report the Machine Name\n\n*Note:* This documentation has been automatically generated from [Marlin's G-Code documentation](https://marlinfw.org/docs/gcode/M550.html).\n\n\n# Marlin parameters\nNote: these are Marlin's G-Code parameters. GCodeCraft.jl does not inforce them.\n* P [Optional]: Set the Machine Name using a string parameter.\n* string [Optional]: Set the Machine Name using a loose string parameter. Must be a quoted string if it starts with \"P.\"\n\n\n# Description\n\nSet the Machine Name using a string parameter. If no parameter is given, report the current Machine Name.",
    ),
    (
        codetype = "M",
    ...
    (
        codetype = "M",
        identifier = (820, 0, nothing),
        funname = "M820",
        doc = "    M820(;params...)\nReport all assigned G-code macros\n\n*Note:* This documentation has been automatically generated from [Marlin's G-Code documentation](https://marlinfw.org/docs/gcode/M820.html).\n\n\n\n\n# Description\n\nReport all macros defined by the commands `M810` through `M819`.\n\n\nSee also [`M810`](@ref), [`M811`](@ref), [`M812`](@ref), [`M813`](@ref), [`M814`](@ref), [`M815`](@ref), [`M816`](@ref), [`M817`](@ref), [`M818`](@ref) and [`M819`](@ref).",
    ),
    (
        codetype = "M",
    ...
    (
        ...
        funname = "M994",
        doc = "    M994(;params...)\nRestore a backup from SD to SPI Flash\n\n*Note:* This documentation has been automatically generated from [Marlin's G-Code documentation](https://marlinfw.org/docs/gcode/M994.html).\n\n\n\n\n# Description\n\nLoad a backup from SD to SPI Flash. Use `M994` to back up SPI Flash to SD.\n\n\nSee also [`M993`](@ref).",
    ),
    (
        codetype = "M",
